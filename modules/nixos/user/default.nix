...
let
  ...
  #     }
  #     ''
  #       local target="$out/share/namsnath-icons/user/${cfg.name}"
  #       mkdir -p "$target"
...
in
{
  options.${namespace}.user = with types; {
    name = mkOpt str "namsnath" "The name to use for the user account.";
    fullName = mkOpt str "Namit Nathwani" "The full name of the user.";
    email = mkOpt str "namsnath@gmail.com" "The email of the user.";
    initialPassword =
      mkOpt str "password"
